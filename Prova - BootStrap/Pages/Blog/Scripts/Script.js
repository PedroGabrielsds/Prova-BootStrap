...
var todosPacotes = []
todosPacotes.push(new Pacote("/Prova - BootStrap/images/cortado/natureza4.png","Nome Lugar", "SUBTITULO", "LOREM", "Post por Pedro"))



todosPacotes.push(new Pacote("/Prova - BootStrap/images/cortado/natureza4.png","Assunto", "SUBTITULO", "LOREM", "Post por Pitter Parker"))
    
    

todosPacotes.push(new Pacote("/Prova - BootStrap/images/cortado/natureza4.png","Viagem", "SUBTITULO", "LOREM", "Post por Hulk"))
...
todosPacotes.forEach(cadaPacote => {
    document.getElementById("comentarios").innerHTML += `
        <div style="width: 33rem; margin:10px; border:1px black solid; box-shadow: 5px 0px 10px black; border-radius: 10px;" background-color: white;>
            <div id="comentarioScript" class="d-flex">
